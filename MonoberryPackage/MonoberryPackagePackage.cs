...
using Monoberry.MonoberryPackage.ProjectFlavor;
...
namespace Monoberry.MonoberryPackage
{
    ...
    //[Guid(GuidList.guidMonoberryPackagePkgString)]
    ...
    [ProvideProjectFactory(typeof(CustomPropertyPageProjectFactory),
        ...
        @"..\Templates\Projects")]
    [Guid(GuidList.guidMonoberryPackagePkgString)]
    public sealed class MonoberryPackagePackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public MonoberryPackagePackage()
        {
